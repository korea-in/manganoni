          ...
          children: [
            ...
            Container(
              ...
              child: ListTile(
                leading: GestureDetector(
                  child: Icon(
                    Icons.verified,
                    color: allCheck() ? themeDeepMain : themeGrey,
                    size: 25,
                  ),
                  onTap: () => {
                    setState(() {
            ...
            ListTile(
              leading: GestureDetector(
                child: Icon(
                  Icons.verified,
                  color: _agree1 ? themeDeepMain : themeGrey,
                  size: 25,
                ),
                onTap: () => {
                  setState(() {
            ...
            ListTile(
              leading: GestureDetector(
                child: Icon(
                  Icons.verified,
                  color: _agree2 ? themeDeepMain : themeGrey,
                  size: 25,
                ),
                onTap: () => {
                  setState(() {
            ...
            ListTile(
              leading: GestureDetector(
                child: Icon(
                  Icons.verified,
                  color: _agree3 ? themeDeepMain : themeGrey,
                  size: 25,
                ),
                onTap: () => {
                  setState(() {
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                    child: Text("모두 동의합니다.",
                        style: TextStyle(
                            color: themeWhite, fontWeight: FontWeight.w800))),
              ),
            ),
          ],
        ),
...
BoxDecoration nextButtonStyle(bool agreeState) {
  return BoxDecoration(
    borderRadius: const BorderRadius.all(Radius.circular(10.0)),
    color: agreeState ? themeDeepMain : themeLightGrey,
  );
}
